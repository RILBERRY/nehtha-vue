            ...
            <div class="flex justify-center mb-3">
                <div class="flex items-center">
                    <div class="flex justify-center items-center">
                        <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white pe-">Vendors Status</h5>
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-3 gap-3 mb-2">
                    <dl class="bg-orange-50 dark:bg-gray-600 rounded-lg flex flex-col items-center justify-center h-[78px]">
                        <dt
                            ...
                            12</dt>
                        <dd class="text-orange-600 dark:text-orange-300 text-xs md:text-sm font-medium">Pending</dd>
                    </dl>
                    <dl class="bg-teal-50 dark:bg-gray-600 rounded-lg flex flex-col items-center justify-center h-[78px]">
                        <dt
                            ...
                            23</dt>
                        <dd class="text-teal-600 dark:text-teal-300 text-xs md:text-sm font-medium">Compeleted</dd>
                    </dl>
                    <dl class="bg-blue-50 dark:bg-gray-600 rounded-lg flex flex-col items-center justify-center h-[78px]">
                        <dt
                            ...
                            64</dt>
                        <dd class="text-blue-600 dark:text-blue-300 text-xs md:text-sm font-medium">Closed</dd>
                    </dl>
                </div>
            </div>
        </div>

        <div class="w-full lg:w-2/6 flex justify-center gap-5 flex-wrap">
            <div class="max-w-sm w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
                <div class="flex justify-between p-2  dark:border-gray-700">
                    <div class="flex items-center">
                        <div
                            class="w-12 h-12 rounded-lg bg-gray-100 dark:bg-gray-700 flex items-center justify-center me-3">
                            <svg class="w-10 h-10 text-gray-500 dark:text-gray-400"
                                aria-hidden="true"
                        ...
                        <div>
                            ...
                            <p class="text-sm font-normal dark:text-gray-400 text-secondary">Requests</p>
                        </div>
                    </div>
                    <div class="">
                        <span
